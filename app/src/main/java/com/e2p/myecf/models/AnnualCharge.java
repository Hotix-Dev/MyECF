...
public class AnnualCharge {
    ...
    public AnnualCharge(String code, String client, Double month_1, Double month_2, Double month_3, Double month_4, Double month_5, Double month_6, Double month_7, Double month_8, Double month_9, Double month_10, Double month_11, Double month_12, Double total) {
        this.code = code;
        this.client = client;
